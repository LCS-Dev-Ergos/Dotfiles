...
SketchyBar 2.24.0 has a local patch in `home/desktop/sketchybar/display-reconcile.patch`.
...
The second native patch, `home/desktop/sketchybar/window-order.patch`, places the
...
clang -fobjc-arc -framework Foundation -framework CoreGraphics \
  home/desktop/sketchybar/tests/window_order.m -o /tmp/sketchybar-window-order-check
