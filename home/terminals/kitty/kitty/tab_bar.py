...
def _fit(text: str, room: int) -> str:
    ...
    directories, ~/Dotfiles/home/terminals/kitty becoming ~/D/h/t/kitty, then falls
    back to just its last component. A path inside a longer title loses its middle, and
