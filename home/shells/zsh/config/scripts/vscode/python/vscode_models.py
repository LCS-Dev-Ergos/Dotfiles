    ...
    def to_dict(self) -> dict[str, str | int | bool | None]:
        ...
        return {
            ...
            "resolved_symlink_target": (
                str(self.resolved_symlink_target)
                if self.resolved_symlink_target
                else None
            ),
...
class ExtensionRemoveReport:
    ...
    failed_paths: tuple[Path, ...]
    skipped_foreign_symlink_count: int = 0
    ...
    def to_dict(self) -> dict[str, object]:
        ...
        return {
            ...
            "skipped_foreign_symlink_count": self.skipped_foreign_symlink_count,
            "failed_paths": [str(path) for path in self.failed_paths],
        }
